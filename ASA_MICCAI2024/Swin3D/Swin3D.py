...
class Swin3DUNet(nn.Module):
    def __init__(self, depths, channels, num_heads, window_sizes, \
                 ...
                 num_layers=5, num_classes=13, stem_transformer=True, first_down_stride=2, upsample='linear',
                 knn_down=True, \
    ...
    def load_pretrained_model(self, ckpt, skip_first_conv=True, verbose=True):
        if os.path.isfile(ckpt):
            ...
            matched_weights = load_state_with_same_shape(self, weights, skip_first_conv=skip_first_conv,
                                                         verbose=verbose)
